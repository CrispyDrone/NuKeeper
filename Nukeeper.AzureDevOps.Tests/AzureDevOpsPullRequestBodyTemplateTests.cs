...
{
    [TestFixture]
    public class AzureDevOpsPullRequestBodyTemplateTests
    {
        ...
        private AzureDevOpsPullRequestBodyTemplate _sut;
        ...
        {
            _sut = new AzureDevOpsPullRequestBodyTemplate();
            _enricher = new PackageUpdateSetEnricher();
            _multiEnricher = new PackageUpdateSetsEnricher(_enricher);
        }

        [Test]
        public void OneUpdate_MakeCommitMessage_IsNotEmpty()
        {
        ...
        [Test]
        public void OneUpdate_MakeCommitMessage_HasStandardTexts()
        {
            var updates = PackageUpdates.For(MakePackageForV110());
        ...
        [Test]
        public void OneUpdate_MakeCommitMessage_HasVersionInfo()
        {
            var updates = PackageUpdates.For(MakePackageForV110());
        ...
        [Test]
        public void OneUpdate_MakeCommitMessage_HasPublishedDate()
        {
            var updates = PackageUpdates.For(MakePackageForV110());
        ...
        [Test]
        public void OneUpdate_MakeCommitMessage_HasProjectDetailsAsMarkdownTable()
        {
            var updates = PackageUpdates.For(MakePackageForV110());
        ...
        [Test]
        public void TwoUpdates_MakeCommitMessage_NotEmpty()
        {
        ...
        [Test]
        public void TwoUpdates_MakeCommitMessage_HasStandardTexts()
        {
            var updates = PackageUpdates.For(MakePackageForV110(), MakePackageForV100());
        ...
        [Test]
        public void TwoUpdates_MakeCommitMessage_HasVersionInfo()
        {
            var updates = PackageUpdates.For(MakePackageForV110(), MakePackageForV100());
        ...
        [Test]
        public void TwoUpdates_MakeCommitMessage_HasProjectList()
        {
            var updates = PackageUpdates.For(MakePackageForV110(), MakePackageForV100());
        ...
        [Test]
        public void TwoUpdatesSameVersion_MakeCommitMessage_NotEmpty()
        {
        ...
        [Test]
        public void TwoUpdatesSameVersion_MakeCommitMessage_HasStandardTexts()
        {
            var updates = PackageUpdates.For(MakePackageForV110(), MakePackageForV110InProject3());
        ...
        [Test]
        public void TwoUpdatesSameVersion_MakeCommitMessage_HasVersionInfo()
        {
            var updates = PackageUpdates.For(MakePackageForV110(), MakePackageForV110InProject3());
        ...
        [Test]
        public void TwoUpdatesSameVersion_MakeCommitMessage_HasProjectList()
        {
            var updates = PackageUpdates.For(MakePackageForV110(), MakePackageForV110InProject3());
        ...
        [Test]
        public void OneUpdate_MakeCommitMessage_HasVersionLimitData()
        {
        ...
        [Test]
        public void OneUpdateWithDate_MakeCommitMessage_HasVersionLimitDataWithDate()
        {
        ...
        [Test]
        public void MakeCommitMessage_DoesNotExceedPullRequestBodyLimit()
        {
            ...
            _enricher.Enrich(updateSet, _sut);
            var report = _sut.Output();
        ...
        public void TwoUpdateSets()
        {
            ...
            Assert.That(report, Does.Not.Contain("<details>"));
            Assert.That(report, Does.Not.Contain("</details>"));
            Assert.That(report, Does.Not.Contain("<summary>"));
            Assert.That(report, Does.Not.Contain("</summary>"));
            Assert.That(report, Does.Contain("## Details of updated packages"));
