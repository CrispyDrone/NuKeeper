...
{
    [TestFixture]
    public class DefaultPullRequestBodyTemplateTests
    {
        private DefaultPullRequestBodyTemplate _sut;
        ...
        {
            _sut = new DefaultPullRequestBodyTemplate();
        ...
        [Test]
        public void OneUpdate_MakeCommitMessage_HasProjectDetails()
        {
            var updates = PackageUpdates.For(MakePackageForV110());
